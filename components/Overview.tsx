...
const Overview: FC = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-[#3C4978] to-[#222B50] p-8 text-white">
      ...
      <main className="w-full max-w-4xl mx-auto text-center">
        ...
        >
          We specialize in delivering cutting-edge web solutions with a focus on
          quality and innovation. Our services include custom design, full-stack
          development, responsive design, and more.
        </motion.p>
        <motion.button
          whileHover={{
            scale: 1.1,
